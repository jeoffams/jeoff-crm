...
const getCurrency = (loc) => {
  ...
  if (l.includes("uk")||l.includes("england")||l.includes("scotland")||l.includes("wales")||l.includes("britain")) return "\u00a3";
  if (l.includes("usa")||l.includes("united states")||l.includes("canada")) return "$";
  if (l.includes("sweden")||l.includes("norway")||l.includes("denmark")) return "kr";
  return "\u20ac";
};
